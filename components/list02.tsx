...
const transactions = [
  { id: 1, title: "Compra Online", amount: -89.99, date: "2023-06-15", icon: ShoppingCart, type: "expense" },
  { id: 2, title: "Depósito Salario", amount: 3500, date: "2023-06-01", icon: Wallet, type: "income" },
  { id: 3, title: "Compra Supermercado", amount: -156.23, date: "2023-06-10", icon: ShoppingCart, type: "expense" },
  { id: 4, title: "Retirada Cajero", amount: -200, date: "2023-06-05", icon: CreditCard, type: "expense" },
  { id: 5, title: "Pago Freelance", amount: 750, date: "2023-06-12", icon: Wallet, type: "income" },
]
